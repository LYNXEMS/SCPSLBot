...
class Patreon:
    ...
    async def on_member_update(self, before, after):
        ...
        if before.roles == after.roles:
            ...
            await self.bot.add_roles(after, discord.utils.get(server.roles, name="Patreon Supporters"))
            return
            ...
            await asyncio.sleep(1)
            await self.bot.remove_roles(after, discord.utils.get(server.roles, name="Patreon Supporters"))
            return
